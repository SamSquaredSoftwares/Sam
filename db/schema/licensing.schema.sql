...
--
-- It is idempotent and additive. When a payment table is present the optional
-- hard-guard trigger is attached automatically (disabled by default); otherwise
-- run  SELECT licence_attach_guard('public.<payment_table>');  once it exists.
--
